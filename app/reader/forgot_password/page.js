  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50 p-6">
      <div className="max-w-md w-full mx-auto bg-white shadow-lg rounded-2xl p-8 text-center">
        <h1 className="text-2xl md:text-3xl font-semibold mb-4 text-[#4e4c4c]">Forgot Password?</h1>
        ...
        <div className="mt-6 text-center text-sm text-gray-600">
          <Link href="/reader/sign_in" className="text-orange-600 font-medium hover:underline">
            Back to Sign In
          </Link>
        </div>
      </div>
